...
public class CalendarItemOnclickListener implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
                            long id) {
        CalendarAdapter.CalendarItemViewHolder viewHolder = (CalendarAdapter.CalendarItemViewHolder) view
                .getTag();
        ...
        CalendarActivity.previousOnclickDateViewPosition[1] = Integer.valueOf(scheduleDay);
